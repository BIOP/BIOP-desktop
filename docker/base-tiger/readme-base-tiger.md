...
## Base image
```
docker build -f base-tiger/Dockerfile-base-tigervnc  -t biop-vnc-base:0.3.1 . --no-cache
```

# To run
```
docker run -it --rm -p 8888:8888 --gpus device=0  --mount src=D:/,target=/home/biop/local,type=bind   biop-vnc-base:0.3.1
```

```
docker tag biop-vnc-base:0.3.1 biop/biop-vnc-base:0.3.1 
docker push biop/biop-vnc-base:0.3.1
```
...
### sub-tests
[x] test stardist 2D and 3D (see stardist readme)
[x] test Fiji : 3Dscript ... 